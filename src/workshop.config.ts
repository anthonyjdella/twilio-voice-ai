...
const workshopConfig: WorkshopConfig = {
  ...
  description:
    "A 90-minute guided workshop where you build a real conversational AI voice application using Twilio ConversationRelay",
  duration: "90 minutes",
  ...
  hero: {
    ...
    description:
      "By the end of this workshop, you\u2019ll have a working voice AI agent that callers can talk to over the phone \u2014 with a custom persona, voice, tool calling, and more.",
