...
export function Verify({ question, onSuccess }: VerifyProps) {
  ...
  return (
    <div className="rounded-xl border border-navy-border bg-white/[0.03] p-6 mb-6 text-center">
      ...
      {state === "idle" && (
        <div className="flex items-center justify-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 rounded-lg bg-white/[0.04] text-text-secondary text-sm font-medium border border-navy-border hover:bg-white/[0.06] transition-colors"
          >
      ...
      {state === "help" && (
        <div className="text-left mt-4 p-4 rounded-lg bg-white/[0.02] border border-navy-border text-sm text-text-secondary leading-relaxed">
