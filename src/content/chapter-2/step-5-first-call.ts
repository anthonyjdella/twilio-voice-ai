...
export default {
  blocks: [
...

    {
      ...
      audience: "explorer",
      content:
        "Everything is wired up -- the server, the AI, and the Twilio connection. Now it is time to hear it in action. Enter your phone number below and Twilio will call you so you can have a live conversation with the AI agent.",
    },
...

    {
      ...
      audience: "builder",
      content:
        "Before you trigger the call, make sure everything is configured:",
    },
...
🚀 Server listening on port 8080`,
...

    {
      type: "prose",
      content:
        "Enter your phone number (with country code, like +12065551234) and hit Call Me. Your phone will ring -- answer it to talk to the AI agent.",
    },
...
{"callSid":"CA1234567890abcdef1234567890abcdef"}`,
...

    {
      ...
      audience: "explorer",
      content:
        "Try interrupting the AI while it is talking -- just start speaking. You should hear it stop mid-sentence and respond to what you said instead. That is the real-time interruption handling at work.",
    },
...
🗣️ Caller: What is the capital of France?`,
    ...
    {
      type: "section",
      title: "You Just Built a Voice AI",
      audience: "builder",
    },
