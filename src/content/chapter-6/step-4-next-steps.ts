...
ws.send(JSON.stringify({
  ...
  last: true
...

        {
            type: "prose",
            content:
                "Twilio offers a **[Conversational Intelligence](https://www.twilio.com/docs/conversation-intelligence-classic)** service that automatically analyzes voice AI calls after they happen:",
        },
...
ws.send(JSON.stringify({
  ...
  loop: 1
...

        {
            type: "prose",
            audience: "builder",
            content: "Continue learning with these resources:",
        },
